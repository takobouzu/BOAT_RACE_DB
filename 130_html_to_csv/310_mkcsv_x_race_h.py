...
'''
def mkcsv_x_race_h():
    print('出走表ヘッダテーブル「x_race_h」のインポートCSVファイル　開始')
    ...
    fw.close()
    print('出走表ヘッダテーブル「x_race_h」のインポートCSVファイル　完了')

#主処理
mkcsv_x_race_h() #レース情報タイトルテーブル「x_race_h」のインポートCSVファイルを作成
